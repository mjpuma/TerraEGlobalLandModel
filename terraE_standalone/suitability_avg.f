...
C     REAL*8 WTA(INA,JNA),A(INA,JNA),B(INB,JNB),
     ...
     *       OFFIA,DIVJA, OFFIB,DIVJB, SKIB,SKIP
      COMMON /HNTRCB/ SINA(0:1081),SINB(0:1081),
     *       FMIN(2160),FMAX(2160),GMIN(1081),GMAX(1081),
     *       IMIN(2160),IMAX(2160),JMIN(1082),JMAX(1082)
      LOGICAL*4 QMPOLE
...
C****
      ...
      JMB = JNB
      SKIP = SKIB
      IF(IMA.lt.1 .or. IMA.gt.2160 .or. JMA.lt.1 .or. JMA.gt.1081 .or.
     *   IMB.lt.1 .or. IMB.gt.2160 .or. JMB.lt.1 .or. JMB.gt.1081)
     *   GO TO 400
C****
...
!======================================================================!
      ...
      include 'netcdf.inc'
!
      integer, parameter :: long_max=2160,lat_max=1080 !GSWP2 dimensions
      ...
      DIVJA=1080.d0 ! # of whole boxes from SP to NP (original grid)
...
!     open file
!      infile='/Users/mpuma/Documents/SUITABILITY/pH_10min.nc'
      infile='/Users/mpuma/Documents/SUITABILITY/orgc_10min.nc'
...
!      varname='pH'
      ...
      do i=1,long_max
         do j = 1,lat_max
!!!!            if((arr2d(i,j)< 1000).or.(arr2d(i,j)> -1))then
            if( arr2d(i,j)< 90000000000 )then
               WTA(i,j) = 1.d0
	    else
               arr2d(i,j)=SKIP
               WTA(i,j) = 0.d0
...
!      infile='/Users/mpuma/Documents/SUITABILITY/pH_144x90.bi'
      infile='/Users/mpuma/Documents/SUITABILITY/orgc_144x90.bi'
...
!======================================================================
      ...
      integer, parameter :: im=144, jm=90
      integer, parameter :: im_1deg=2160, jm_1deg=1080
      integer :: iu_var
